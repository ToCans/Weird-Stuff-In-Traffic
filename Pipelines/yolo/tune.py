...
def objective(trial):
    ...
    freeze = trial.suggest_int('freeze', 0, 5)  # Number of layers to freeze 
    ...
    # Augmentation parameters to optimize
    hsv_h = trial.suggest_float('hsv_h', 0.0, 0.1)  # Hue 
    hsv_s = trial.suggest_float('hsv_s', 0.0, 0.9)  # Saturation 
    hsv_v = trial.suggest_float('hsv_v', 0.0, 0.9)  # Brightness
